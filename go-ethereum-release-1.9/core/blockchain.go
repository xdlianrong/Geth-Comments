...
// InsertChain尝试将给定批量的block插入到规范链中，否则，创建一个分叉。 如果返回错误，它将返回失败块的索引号以及描述错误的err。
// 插入完成后，将触发所有累积的事件。
...
func (bc *BlockChain) GetCMdb() ethdb.Database { return bc.CMdb }
